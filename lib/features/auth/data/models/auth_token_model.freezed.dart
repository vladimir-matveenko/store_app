...
mixin _$AuthTokenModel {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is AuthTokenModel &&
...
abstract mixin class $AuthTokenModelCopyWith<$Res> {
  factory $AuthTokenModelCopyWith(AuthTokenModel value,
      $Res Function(AuthTokenModel) _then) = _$AuthTokenModelCopyWithImpl;
...
extension AuthTokenModelPatterns on AuthTokenModel {
  ...
  TResult Function( _AuthTokenModel value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _AuthTokenModel implements AuthTokenModel {
  const _AuthTokenModel(
      {@JsonKey(name: 'access_token') required this.accessToken, @JsonKey(
          name: 'refresh_token') required this.refreshToken});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _AuthTokenModel &&
            (identical(other.accessToken, accessToken) ||
                other.accessToken == accessToken) &&
            (identical(other.refreshToken, refreshToken) ||
                other.refreshToken == refreshToken));
...
abstract mixin class _$AuthTokenModelCopyWith<$Res>
    implements $AuthTokenModelCopyWith<$Res> {
  factory _$AuthTokenModelCopyWith(_AuthTokenModel value,
      $Res Function(_AuthTokenModel) _then) = __$AuthTokenModelCopyWithImpl;
