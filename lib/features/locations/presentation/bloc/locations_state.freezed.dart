...
mixin _$LocationsState {
 ...
 bool get isLoading; bool get showGeoModal; String? get error; List<LocationEntity> get locations; LocationEntity? get selectedLocation; List<Marker> get markers; LatLng get center;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,showGeoModal,error,const DeepCollectionEquality().hash(locations),selectedLocation,const DeepCollectionEquality().hash(markers),center);

@override
String toString() {
  return 'LocationsState(isLoading: $isLoading, showGeoModal: $showGeoModal, error: $error, locations: $locations, selectedLocation: $selectedLocation, markers: $markers, center: $center)';
}
...
@useResult
$Res call({
 bool isLoading, bool showGeoModal, String? error, List<LocationEntity> locations, LocationEntity? selectedLocation, List<Marker> markers, LatLng center
});
...
/// Create a copy of LocationsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? showGeoModal = null,Object? error = freezed,Object? locations = null,Object? selectedLocation = freezed,Object? markers = null,Object? center = null,}) {
...
as List<LocationEntity>,selectedLocation: freezed == selectedLocation ? _self.selectedLocation : selectedLocation // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  bool showGeoModal,  String? error,  List<LocationEntity> locations,  LocationEntity? selectedLocation,  List<Marker> markers,  LatLng center)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocationsState() when $default != null:
return $default(_that.isLoading,_that.showGeoModal,_that.error,_that.locations,_that.selectedLocation,_that.markers,_that.center);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  bool showGeoModal,  String? error,  List<LocationEntity> locations,  LocationEntity? selectedLocation,  List<Marker> markers,  LatLng center)  $default,) {final _that = this;
switch (_that) {
case _LocationsState():
return $default(_that.isLoading,_that.showGeoModal,_that.error,_that.locations,_that.selectedLocation,_that.markers,_that.center);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  bool showGeoModal,  String? error,  List<LocationEntity> locations,  LocationEntity? selectedLocation,  List<Marker> markers,  LatLng center)?  $default,) {final _that = this;
switch (_that) {
case _LocationsState() when $default != null:
return $default(_that.isLoading,_that.showGeoModal,_that.error,_that.locations,_that.selectedLocation,_that.markers,_that.center);case _:
  return null;
...
class _LocationsState implements LocationsState {
  const _LocationsState({this.isLoading = false, this.showGeoModal = false, this.error, final  List<LocationEntity> locations = const [], this.selectedLocation, final  List<Marker> markers = const [], this.center = const LatLng(50.4501, 30.5234)}): _locations = locations,_markers = markers;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,showGeoModal,error,const DeepCollectionEquality().hash(_locations),selectedLocation,const DeepCollectionEquality().hash(_markers),center);
...
/// Create a copy of LocationsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? showGeoModal = null,Object? error = freezed,Object? locations = null,Object? selectedLocation = freezed,Object? markers = null,Object? center = null,}) {
