...
TResult map<TResult extends Object?>(
    {required TResult Function( LocationsFetched value) locationsFetched, required TResult Function( LocationSelected value) locationSelected, required TResult Function( LocationUpdated value) locationUpdated, required TResult Function( GeoStatusChecked value) geoStatusChecked, required TResult Function( GeoStatusModalDisabled value) geoStatusModalDisabled,}) {
  final _that = this;
  switch (_that) {
    case LocationsFetched():
      return locationsFetched(_that);
    case LocationSelected():
      return locationSelected(_that);
    case LocationUpdated():
      return locationUpdated(_that);
    case GeoStatusChecked():
      return geoStatusChecked(_that);
    case GeoStatusModalDisabled():
      return geoStatusModalDisabled(_that);
    case _:
...
TResult? mapOrNull<TResult extends Object?>(
    {TResult? Function( LocationsFetched value)? locationsFetched, TResult? Function( LocationSelected value)? locationSelected, TResult? Function( LocationUpdated value)? locationUpdated, TResult? Function( GeoStatusChecked value)? geoStatusChecked, TResult? Function( GeoStatusModalDisabled value)? geoStatusModalDisabled,}) {
  final _that = this;
  switch (_that) {
    case LocationsFetched() when locationsFetched != null:
      return locationsFetched(_that);
    case LocationSelected() when locationSelected != null:
      return locationSelected(_that);
    case LocationUpdated() when locationUpdated != null:
      return locationUpdated(_that);
    case GeoStatusChecked() when geoStatusChecked != null:
      return geoStatusChecked(_that);
    case GeoStatusModalDisabled() when geoStatusModalDisabled != null:
      return geoStatusModalDisabled(_that);
    case _:
      return null;
  }
