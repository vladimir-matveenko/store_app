...
mixin _$UsersState {
  ...
  /// pagination
  bool get isShowUsersLoader;

  bool get hasReachedMaxUsers;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UsersState &&
            ...
            (identical(other.isShowUsersLoader, isShowUsersLoader) ||
                other.isShowUsersLoader == isShowUsersLoader) &&
            (identical(other.hasReachedMaxUsers, hasReachedMaxUsers) ||
                other.hasReachedMaxUsers == hasReachedMaxUsers) &&
...
abstract mixin class $UsersStateCopyWith<$Res> {
  factory $UsersStateCopyWith(UsersState value,
      $Res Function(UsersState) _then) = _$UsersStateCopyWithImpl;

  @useResult
  $Res call({
    bool isInitialized, bool isLoading, bool isUserLoading, bool isShowUsersLoader, bool hasReachedMaxUsers, String? error, List<
        UserEntity> users, UserEntity? user
  });
...
class _$UsersStateCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? isInitialized = null, Object? isLoading = null, Object? isUserLoading = null, Object? isShowUsersLoader = null, Object? hasReachedMaxUsers = null, Object? error = freezed, Object? users = null, Object? user = freezed,}) {
    return _then(_self.copyWith(
      ...
      as bool,
      isShowUsersLoader: null == isShowUsersLoader
          ? _self.isShowUsersLoader
          : isShowUsersLoader // ignore: cast_nullable_to_non_nullable
      as bool,
      hasReachedMaxUsers: null == hasReachedMaxUsers
          ? _self.hasReachedMaxUsers
          : hasReachedMaxUsers // ignore: cast_nullable_to_non_nullable
      as bool,
      error: freezed == error
          ? _self.error
...
extension UsersStatePatterns on UsersState {
  ...
  TResult Function( _UsersState value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UsersState implements UsersState {
  const _UsersState(
      {this.isInitialized = false, this.isLoading = false, this.isUserLoading = false, this.isShowUsersLoader = false, this.hasReachedMaxUsers = false, this.error, final List<
          UserEntity> users = const [], this.user}) : _users = users;
  ...
  @override
  @JsonKey()
  final bool isShowUsersLoader;
  @override
  @JsonKey()
  final bool hasReachedMaxUsers;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _UsersState &&
            (identical(other.isInitialized, isInitialized) ||
                other.isInitialized == isInitialized) &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
...
abstract mixin class _$UsersStateCopyWith<$Res>
    implements $UsersStateCopyWith<$Res> {
  factory _$UsersStateCopyWith(_UsersState value,
      $Res Function(_UsersState) _then) = __$UsersStateCopyWithImpl;
